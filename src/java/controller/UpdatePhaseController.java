 ...
 * @author Legion
 */
@WebServlet(name="UpdatePhaseController", urlPatterns={"/update-phase"})
public class UpdatePhaseController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdatePhaseController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdatePhaseController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            System.out.println("UpdatePhase: DATE");
        }
        ...
        new ProjectPhaseDAO().updateProjectPhase(phase);
