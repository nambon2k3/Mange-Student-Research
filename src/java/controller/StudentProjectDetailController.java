 ...
 * @author Legion
 */
@WebServlet(name="StudentProjectDetailController", urlPatterns={"/student-project-detail"})
public class StudentProjectDetailController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet StudentProjectDetailController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet StudentProjectDetailController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("student-project-detail.jsp").forward(request, response);
    } 
